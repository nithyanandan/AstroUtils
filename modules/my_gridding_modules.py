...
def conv_grid1d(xc, xkern, kernel, xgrid, method='NN'):
    ...
    xc:      [vector as list or numpy array] x-coordinates of center of
             gridding function 

    xkern:   [vector as list or numpy array] x-coordinates of gridding
             function

    kernel:  [vector as list or numpy array] gridding function (or kernel). 
             If kernel is a scalar, a nearest neighbour interpolation is 
             used overriding the method requested for. This kernel will be
             interpolated at the requested locations in xgrid

    xgrid:   [vector as list or numpy array] x-coordinates of grid locations
             at which interpolates are required
...
def conv_grid2d(xc, yc, xkern, ykern, kernel, xgrid, ygrid, method='NN'):
    ...
    xc:      [vector as list of numpy array] x-coordinates of center of
             gridding function 

    yc:      [vector as list or numpy array] y-coordinates of center of
             gridding function 

    xkern:   [vector as list or numpy array] x-coordinates of gridding
             function

    ykern:   [vector as list or numpy array] y-coordinates of gridding
             function
    ...
    xgrid:   [vector as list or numpy array] x-coordinates of grid
             locations at which interpolates are required

    ygrid:   [vector as list or numpy array] y-coordinates of grid
             locations at which interpolates are required
